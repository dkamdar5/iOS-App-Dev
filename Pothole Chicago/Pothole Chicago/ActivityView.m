...
static CGFloat const ActivityViewActivityIndicatorPadding = 10.f;
...
- (void)layoutSubviews {
	...
	self.activityIndicator.center = CGPointMake(self.label.frame.origin.x - (self.activityIndicator.frame.size.width / 2) - ActivityViewActivityIndicatorPadding, self.label.frame.origin.y + (self.label.frame.size.height / 2));
}
